...
#endif
DllExport extern void  mr_shift(_MIPT_ big, int, big);
extern miracl *mr_first_alloc(void);
DllExport extern void  *mr_alloc(_MIPT_ int, int);
DllExport extern void  mr_free(void *);
extern void  set_user_function(_MIPT_ BOOL (*)(void));
DllExport extern void  set_io_buffer_size(_MIPT_ int);
...
DllExport extern void  convert(_MIPT_ int, big);
DllExport extern void  uconvert(_MIPT_ unsigned int, big);
DllExport extern void  lgconv(_MIPT_ long, big);
DllExport extern void  ulgconv(_MIPT_ unsigned long, big);
...
DllExport extern flash mirvar(_MIPT_ int);
extern flash mirvar_mem(_MIPT_ char *,int);
DllExport extern void  mirkill(big);
...
#else
DllExport extern miracl *mirsys(int, mr_small);
#endif
extern miracl *mirsys_basic(miracl *,int,mr_small);
DllExport extern void  mirexit(_MIPTO_);
extern int   exsign(flash);
extern void  insign(int,flash);
DllExport extern int   getdig(_MIPT_ big, int);
extern int   numdig(_MIPT_ big);        
DllExport extern void  putdig(_MIPT_ int, big, int);
DllExport extern void  copy(flash, flash);
DllExport extern void  negify(flash, flash);
extern void  absol(flash,flash); 
DllExport extern int   size(big);
DllExport extern int   mr_compare(big, big);
DllExport extern void  add(_MIPT_ big, big, big);
DllExport extern void  subtract(_MIPT_ big, big, big);
DllExport extern void  incr(_MIPT_ big, int, big);
DllExport extern void  decr(_MIPT_ big, int, big);
DllExport extern void  premult(_MIPT_ big, int, big);
DllExport extern int   subdiv(_MIPT_ big, int, big);
extern BOOL  subdivisible(_MIPT_ big,int);
DllExport extern int   remain(_MIPT_ big, int);
...
DllExport extern void  multiply(_MIPT_ big, big, big);
extern void  fft_mult(_MIPT_ big,big,big);
extern BOOL  fastmultop(_MIPT_ int,big,big,big);
DllExport extern void  divide(_MIPT_ big, big, big);
extern BOOL  divisible(_MIPT_ big,big);   
extern void  mad(_MIPT_ big,big,big,big,big,big);
DllExport extern int   instr(_MIPT_ flash, char *);
DllExport extern int   otstr(_MIPT_ flash, char *);
DllExport extern int   cinstr(_MIPT_ flash, char *);
...
DllExport extern void  sftbit(_MIPT_ big, int, big);
